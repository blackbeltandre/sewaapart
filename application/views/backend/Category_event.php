  <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                              <form class="form-horizontal" action="<?php echo base_url(); ?>backend/category_event/proses" method="post" enctype="multipart/form-data" data-validate="parsley">
                                   
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Category Event</label></div>
                                        <div class="col-12 col-md-3"><input type="text" class="form-control" data-required="true" name="category" value="<?php echo set_value('category'); ?>" placeholder="Category Article">                        
