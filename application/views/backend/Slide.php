              ...
              <div class="col-md-12">
                  <div class="panel panel-primary" id="demo">
                      <div class="panel-heading">
                          <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-table22"></i></span> Slide Menu</h3>
                            ...
                            <div class="panel-toolbar text-left"></div>
                                ...
                                <?php echo form_error('title'); ?>
                                 ...
                                 <div class="col-sm-6">
                                  ...
                                  <input type="text" class="form-control" data-required="true" name="sub_title" placeholder="Sub Title" value="<?php echo set_value('sub_title'); ?>"/>
                                ...
                                <div class="col-sm-6">
                                      ...
                                      <label>Foto</label>
                                        ...
                                        <br>
                                      <code><font size="1.4"><h>Resolusi terbaik ukuran 1900x1080</h></font></code>          
                               </div></div>
