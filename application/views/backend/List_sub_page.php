...
<script src="<?php echo base_url(); ?>assets/js/jquery.min.js"></script>
                              ...
                              <form action="<?php echo base_url(); ?>backend/sub_page/cek" method="post">
             <?php echo $this->session->flashdata('message'); ?>
                    <div class="col-md-12">
                        <div class="panel panel-primary" id="demo">
                            <div class="panel-heading">
                                <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-users"></i></span> Menu Description</h3>
                                <div class="panel-toolbar text-right">
                                </div>
                            </div>
                                <div class="panel-toolbar text-right" id="demo">
                                    <div class="btn-group">
                                   <a type="button" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="Add data?" href="<?php echo base_url('backend/sub_page');?>"><i class="icon ico-pencil"></i> Add Data ?</a>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive panel-collapse pull out">
                               <div class="col-md-3">
                                  <select class="form-control mt4" name="action">
                                    ...
                                    <input type="submit" id="selected" name="selected" class="btn btn-s-md btn-info" formaction="<?php echo base_url(); ?>backend/sub_page/delete_multiple" value="Proses ?" ><p align="right"></p>
                          <script>
                                  jQuery(function ($) {
                  ...
                  <table class="table table-striped table-bordered table-hover" id="row-detail">
                    <thead>
                      <tr>
                        ...
                        <th class="th-sortable" data-toggle="class"  style="width:25%">Title<span class="th-sort">
                          </span></th>
                    ...
                    if(empty($sub_page))
                     ...
                     <tr>
                  <th style="width:5%">
               <input type="checkbox" name="selected[]" id="selected-<?php echo $selected; ?>" class="selected" value="<?php echo $sub_page[$i]["id_sub_page"]; ?>" data-toggle="checkall" data-target="#table1">  
                   <th  style="width:5%"><?php echo ($page+$i+1); ?></th>
                       <th  style="width:25%"><?php echo $sub_page[$i]["title"]; ?></th>
                         <th  style="width:5%"><?php echo $sub_page[$i]["date_post"]; ?></th>
                          <th  style="width:5%"><?php if($sub_page[$i]["lang"]=="EN"){
                          ...
                          if ($sub_page[$i]["status"]  == 1) 
                          {
                              echo '<strong>Publish</strong>';
                          } 
                          elseif ($sub_page[$i]["status"] == 0) 
                          {
                              echo '<u>Draft</u>';
                          }
                          ?></th>
                          <th  style="width:10%"><?php
                          echo $sub_page[$i]["author"]
                          ?>
                        </th>
                          <th  style="width:10%"><?php echo word_limiter($sub_page[$i]["description"],5); ?></th>
                          <th  style="width:10%"><center><img src="<?php echo base_url();?>assets/foto/<?php echo $sub_page[$i]["foto"];?>" width="60" height="60" onError="this.onerror=null;this.src='<?php echo base_url();?>assets/foto/foto.jpg';" width="60" height="60" /></center></th>
                        <th  style="width:10%">   <center><a type="button" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="left" title="Update data?" href="<?php echo base_url('backend/sub_page/edit_sub_page');?>/<?php echo $sub_page[$i]["id_sub_page"] ?>"><font color="white"><i class="icon-document-edit"></i></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="bottom" title="Delete Data?" href="<?php echo base_url('backend/sub_page/delete');?>/<?php echo $sub_page[$i]["id_sub_page"] ?>"onClick="return confirm('Anda Yakin Akan Menghapus Data Ini?');"><i class="icon-trash"></i></a></center></th>
                   </tr> 
                   <?php
                    $selected++;
                       $selected = $selected++;
