         ...
         <div class="row">
                  ...
                  <table class="table table-striped table-bordered table-hover" id="row-detail">
                   ...
                   <th  style="width:10%"><?php echo ($page+$i+1); ?></th>
                       ...
                       <th  style="width:30%"><?php echo word_limiter($faq[$i]["description"], 400); ?></th>                    
                      ...
                      <a type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="bottom" title="Delete Data?" href="<?php echo base_url('backend/faq/delete');?>/<?php echo $faq[$i]["id_faq"] ?>"onClick="return confirm('Anda Yakin Akan Menghapus Data Ini?');"><i class="icon-trash"></i></a></center></th>
                   </tr> 
                   <?php
                    $selected++;
                       $selected = $selected++;
