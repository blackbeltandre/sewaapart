                            ...
                            <div class="table-responsive panel-collapse pull out">
                               <div class="col-md-3">
                                  <select class="form-control mt4" name="action">
                                    ...
                                    <input type="submit" id="selected" name="selected" class="btn btn-s-md btn-info" formaction="<?php echo base_url(); ?>backend/webmaster/delete_multiple" value="Proses ?" ><p align="right"></p>
                          <script>
                                  jQuery(function ($) {
                  ...
                  <table class="table table-striped table-bordered table-hover" id="row-detail">
                    <thead>
                      <tr>
                        ...
                        <th class="th-sortable" data-toggle="class"  style="width:5%">Username<span class="th-sort">
                          </span></th>
                        <th class="th-sortable" data-toggle="class"  style="width:5%">Password<span class="th-sort">
                          </span></th>
                           <th class="th-sortable" data-toggle="class"  style="width:5%">Status<span class="th-sort">
                          </span></th>
                           <th class="th-sortable" data-toggle="class"  style="width:10%">Level Login<span class="th-sort">
                          </span></th></th>
                           <th class="th-sortable" data-toggle="class"  style="width:10%">Name<span class="th-sort">
                          </span></th>
                           <th class="th-sortable" data-toggle="class"  style="width:10%">Picture<span class="th-sort">
                          </span></th>
                    ...
                    if(empty($webmaster))
                     ...
                     <tr>
                  <th style="width:5%">
               <input type="checkbox" name="selected[]" id="selected-<?php echo $selected; ?>" class="selected" value="<?php echo $webmaster[$i]["id_administrator"]; ?>" data-toggle="checkall" data-target="#table1">  
                   <th  style="width:5%"><?php echo ($page+$i+1); ?></th>
                       <th  style="width:5%"><?php echo $webmaster[$i]["username"]; ?></th>
                         <th  style="width:5%"><?php echo $webmaster[$i]["password"]; ?></th>
                          ...
                          <th  style="width:10%"><?php echo $webmaster[$i]["name"]; ?></th>
                          <th  style="width:10%"><img src="<?php echo base_url();?>assets/foto/<?php echo $webmaster[$i]["foto"];?>" width="60" height="60" onError="this.onerror=null;this.src='<?php echo base_url();?>assets/foto/foto.jpg';" width="60" height="60" /></th>
                        <th  style="width:10%">   <center><a type="button" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="left" title="Update data?" href="<?php echo base_url('backend/webmaster/edit_user');?>/<?php echo $webmaster[$i]["id_administrator"] ?>"><font color="white"><i class="icon-document-edit"></i></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="bottom" title="Delete Data?" href="<?php echo base_url('backend/webmaster/delete');?>/<?php echo $webmaster[$i]["id_administrator"] ?>"onClick="return confirm('Anda Yakin Akan Menghapus Data Ini?');"><i class="icon-trash"></i></a></center></th>
                   </tr> 
                   <?php
                    $selected++;
                       $selected = $selected++;
