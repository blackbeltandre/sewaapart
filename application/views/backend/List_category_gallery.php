             ...
             <?php echo $this->session->flashdata('message'); ?>
               ...
               <input type="checkbox" name="selected[]" id="selected-<?php echo $selected; ?>" class="selected" value="<?php echo $category_gallery[$i]["id_category"]; ?>" data-toggle="checkall" data-target="#table1">  
                   <th  style="width:5%"><?php echo ($page+$i+1); ?></th>
                        ...
                        <th  style="width:10%">   <center><a type="button" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="left" title="Update data?" href="<?php echo base_url('backend/category_gallery/edit_category_gallery');?>/<?php echo $category_gallery[$i]["id_category"] ?>"><font color="white"><i class="icon-document-edit"></i></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="bottom" title="Delete Data?" href="<?php echo base_url('backend/category_gallery/delete');?>/<?php echo $category_gallery[$i]["id_category"] ?>"onClick="return confirm('Anda Yakin Akan Menghapus Data Ini?');"><i class="icon-trash"></i></a></center></th>
                   </tr> 
                   <?php
                    $selected++;
                       $selected = $selected++;
