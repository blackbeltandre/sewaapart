                   ...
                   <th  style="width:10%"><?php echo ($page+$i+1); ?></th>
                       ...
                       <th  style="width:5%"><?php
                          ...
                          <?php }else{ ?>
                            ...
                            <?php } ?> </th>
                       <th  style="width:30%">   <a type="button" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="left" title="Update data?" href="<?php echo base_url('backend/slide/edit_slide');?>/<?php echo $slide[$i]["id"] ?>"><font color="white"><i class="icon-document-edit"></i></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="right" title="Delete Data?" href="<?php echo base_url('backend/slide/delete');?>/<?php echo $slide[$i]["id"] ?>"onClick="return confirm('Anda Yakin Akan Menghapus Data Ini?');"><i class="icon-trash"></i></a></th>
                   </tr> 
                   <?php
                    $selected++;
                       $selected = $selected++;
