                    ...
                    <thead>
                      <tr>
                       ...
                       -->     <th class="th-sortable" data-toggle="class"  style="width:5%">Status<span class="th-sort">
                           ...
                           <th class="th-sortable" data-toggle="class"  style="width:10%">Category<span class="th-sort">
                          </span></th></th>
                   ...
                   <th  style="width:5%"><?php echo ($page+$i+1); ?></th>
                       <th  style="width:5%"><?php echo $gallery[$i]["title"]; ?></th>
                        ...
                        -->   <th  style="width:5%"><?php
                          ...
                          ?></th>
                          <th  style="width:10%"><font color="red"><u><strong><?php
                          echo $gallery[$i]["category"]
                          ?></u></strong></font>
                        </th>
                        ...
                        <th  style="width:10%">   <center><a type="button" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="left" title="Update data?" href="<?php echo base_url('backend/gallery/edit_gallery');?>/<?php echo $gallery[$i]["id_gallery"] ?>"><font color="white"><i class="icon-document-edit"></i></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="bottom" title="Delete Data?" href="<?php echo base_url('backend/gallery/delete');?>/<?php echo $gallery[$i]["id_gallery"] ?>"onClick="return confirm('Anda Yakin Akan Menghapus Data Ini?');"><i class="icon-trash"></i></a></center></th>
                   </tr> 
                   <?php
                    $selected++;
                       $selected = $selected++;
