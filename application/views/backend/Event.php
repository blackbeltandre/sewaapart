...
<body> 
  <div class="col-lg-12">
      ...
      <form data-validate="parsley" action="<?php echo base_url(); ?>backend/event/proses" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                                  ...
                                  <select name="id_category" class="form-control">
                                   <?php foreach($list_category as $list_category){ ?>
                                    <option value="<?php echo $list_category["id_category"]; ?>">
                                      <?php echo $list_category["category"]; ?></option><?php } ?></select><?php echo form_error('id_category'); ?></div></div>
