!function($, wysi) {
    ...
    var tpl = {
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-modal modal hide fade'>" +
                ...
                "</div>" +
              "</div>" +
              "<a class='btn" + size + "' data-wysihtml5-command='insertImage' title='" + locale.image.insert + "' tabindex='-1'><i class=' fa-lg fa fa-power-off'></i></a>" +
            "</li>";
        },
        ...
        "html": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='btn" + size + "' data-wysihtml5-action='change_view' title='" + locale.html.edit + "' tabindex='-1'><i class=' fa-lg fa fa-power-off'></i></a>" +
              "</div>" +
            "</li>";
        },
