...
var base_url = 'http://sewaapart.local/assets/desain_backend/';
...
head.js(base_url+"assets/js/custom/scriptbreaker-multiple-accordion-1.js", function() {
    ...
    $(".topnav").accordionze({
        accordionze: true,
        speed: 500,
        closedSign: '<img src="http://sewaapart.local/assets/desain_backend/assets/img/plus.png">',
        openedSign: '<img src="http://sewaapart.local/assets/desain_backend/assets/img/minus.png">'
    });
